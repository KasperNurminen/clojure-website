...
var G__3069 = o;
(G__3069[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__3071__i = 0, G__3071__a = new Array(arguments.length -  0);
while (G__3071__i < G__3071__a.length) {G__3071__a[G__3071__i] = arguments[G__3071__i + 0]; ++G__3071__i;}
...
var G__3075 = jsprops;
(G__3075["defaultValue"] = value);

(G__3075["onChange"] = ((function (G__3075,v,value,on_change){
return (function (p1__3074_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__3074_SHARP_);
});})(G__3075,v,value,on_change))
);
...
var vec__3078 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3078,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3078,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3078,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___3082 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___3082 == null)){
} else {
var key_3083 = temp__4661__auto___3082;
(jsprops["key"] = key_3083);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__3084 = reagent.impl.template.__GT_NativeWrapper();
(G__3084["name"] = c);
...
var G__3085 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__3085) : reagent.impl.template.as_element.call(null,G__3085));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3088){
var G__3089 = cljs.core.first(seq3088);
var seq3088__$1 = cljs.core.next(seq3088);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3089,seq3088__$1);
});
...
break;
default:
var G__3095 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__3095;
continue;
...
var n__4376__auto___3097 = a.length;
var i_3098 = (0);
while(true){
if((i_3098 < n__4376__auto___3097)){
(a[i_3098] = reagent.impl.template.as_element((a[i_3098])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___3100 = a.length;
var i_3101 = (0);
while(true){
if((i_3101 < n__4376__auto___3100)){
var val_3102 = (a[i_3101]);
if(((cljs.core.vector_QMARK_(val_3102)) && ((reagent.impl.template.key_from_vec(val_3102) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_3101] = reagent.impl.template.as_element(val_3102));
...
var ctx = ({});
var vec__3104 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3104,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3104,(1),null);
...
var G__3107 = (cljs.core.count(argv) - first_child);
switch (G__3107) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__3107){
