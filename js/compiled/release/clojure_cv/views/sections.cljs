...
(defn portfolio []
  (r/create-class
    {:component-did-mount (fn []
                            (js/console.log "Tilting now!")
                            (js/setTimeout #(.init js/VanillaTilt (.querySelectorAll js/document ".portfolio-image") (clj->js {:scale 1.05
                                                                                                                              :max   2})) 1000))
     :reagent-render      (fn []
                            [:section#portfolio
                             [:div {:style {:padding "2rem"}}
                              ...
                              [:div.d-flex.flex-wrap {:style {
                               ...
                               [:div.portfolio-image {:data-tilt true
