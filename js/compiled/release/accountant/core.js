...
var G__11721 = history;
var G__11722 = goog.history.EventType.NAVIGATE;
var G__11723 = ((function (G__11721,G__11722){
return (function (e){
var token = e.token;
...
;
return goog.events.listen(G__11721,G__11722,G__11723);
});
/**
...
var G__11725 = document;
var G__11726 = "click";
var G__11727 = ((function (G__11725,G__11726){
return (function (e){
var target = e.target;
var button = e.button;
...
var and__3911__auto____$1 = (function (){var fexpr__11730 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__11730.cljs$core$IFn$_invoke$arity$1 ? fexpr__11730.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__11730.call(null,link_target));
})();
if(cljs.core.truth_(and__3911__auto____$1)){
...
var G__11731 = history;
var G__11732 = (new goog.history.Event(path,true));
return goog.events.dispatchEvent(G__11731,G__11732);
} else {
return null;
}
} else {
...
;
return goog.events.listen(G__11725,G__11726,G__11727);
});
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__11733){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11734__$1,cljs.core.cst$kw$nav_DASH_handler);
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11734__$1,cljs.core.cst$kw$path_DASH_exists_QMARK_);
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11734__$1,cljs.core.cst$kw$reload_DASH_same_DASH_path_QMARK_);
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11736_SHARP_){
return cljs.core.name(p1__11736_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__11737_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__11741 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__11741) : accountant.core.nav_handler.call(null,G__11741));
} else {
