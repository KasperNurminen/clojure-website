...
(def texts {:main
            ...
            :kaspernurminenfi {:title "kaspernurminen.fi"
                               :text  [:div
                                       [:p "kaspernurminen.fi is hand crafted using ClojureScript, reagent, re-frame and material-ui. It uses secretary and accountant for navigation and the icons are from material icons. The CSS is compiled with Sass and it is hosted via Github Pages."]
